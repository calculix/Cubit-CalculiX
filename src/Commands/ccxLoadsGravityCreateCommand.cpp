...
ccxLoadsGravityCreateCommand::ccxLoadsGravityCreateCommand()
{}

ccxLoadsGravityCreateCommand::~ccxLoadsGravityCreateCommand()
{}

std::vector<std::string> ccxLoadsGravityCreateCommand::get_syntax()
{
...
std::vector<std::string> ccxLoadsGravityCreateCommand::get_syntax_help()
{
...
std::vector<std::string> ccxLoadsGravityCreateCommand::get_help()
{
  std::vector<std::string> help;
  return help;
}

bool ccxLoadsGravityCreateCommand::execute(CubitCommandData &data)
{
