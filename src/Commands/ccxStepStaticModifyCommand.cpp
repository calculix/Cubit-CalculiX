...
ccxStepStaticModifyCommand::ccxStepStaticModifyCommand()
{}

ccxStepStaticModifyCommand::~ccxStepStaticModifyCommand()
{}

std::vector<std::string> ccxStepStaticModifyCommand::get_syntax()
{
  std::vector<std::string> syntax_list;
  std::string syntax = "ccx ";
  syntax.append("modify step <value:label='step id',help='<step id>'> ");
  syntax.append("static ");
...
std::vector<std::string> ccxStepStaticModifyCommand::get_syntax_help()
{
  std::vector<std::string> help(1);
  help[0] = "ccx ";
  help[0].append("modify step <step id> ");
  help[0].append("static ");
...
std::vector<std::string> ccxStepStaticModifyCommand::get_help()
{
  std::vector<std::string> help;
  return help;
}

bool ccxStepStaticModifyCommand::execute(CubitCommandData &data)
{
  ...
  if (!ccx_iface.modify_step(step_id, 2, options, options_marker))
  {
    output = "Failed!\n";
    PRINT_ERROR(output.c_str());
  }
