...
ccxStepRemoveBCCommand::ccxStepRemoveBCCommand()
{}

ccxStepRemoveBCCommand::~ccxStepRemoveBCCommand()
{}

std::vector<std::string> ccxStepRemoveBCCommand::get_syntax()
{
...
std::vector<std::string> ccxStepRemoveBCCommand::get_syntax_help()
{
  std::vector<std::string> help(5);
  help[0] = "ccx step <step id> remove bc [displacement <displacement id>...] [temperature <temperature id>...]"; 

  return help;
}

std::vector<std::string> ccxStepRemoveBCCommand::get_help()
{
  std::vector<std::string> help;
  return help;
}

bool ccxStepRemoveBCCommand::execute(CubitCommandData &data)
{
