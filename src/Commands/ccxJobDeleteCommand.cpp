...
ccxJobDeleteCommand::ccxJobDeleteCommand()
{}

ccxJobDeleteCommand::~ccxJobDeleteCommand()
{}

std::vector<std::string> ccxJobDeleteCommand::get_syntax()
{
...
std::vector<std::string> ccxJobDeleteCommand::get_syntax_help()
{
...
std::vector<std::string> ccxJobDeleteCommand::get_help()
{
  std::vector<std::string> help;
  return help;
}

bool ccxJobDeleteCommand::execute(CubitCommandData &data)
{
