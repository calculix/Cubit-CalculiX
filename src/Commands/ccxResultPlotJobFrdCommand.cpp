...
ccxResultPlotJobFrdCommand::ccxResultPlotJobFrdCommand()
{}

ccxResultPlotJobFrdCommand::~ccxResultPlotJobFrdCommand()
{}

std::vector<std::string> ccxResultPlotJobFrdCommand::get_syntax()
{
...
std::vector<std::string> ccxResultPlotJobFrdCommand::get_syntax_help()
{
  std::vector<std::string> help(1);
  help[0] = "ccx result plot job <job_id> frd {x_node_id <x_node_id> x_block_type <x_block_type> x_block_component <x_block_type>|x_increment|x_time} {y_node_id <y_node_id> y_block_type <y_block_type> y_block_component <y_block_type>|y_increment|y_time}"; 
...
std::vector<std::string> ccxResultPlotJobFrdCommand::get_help()
{
  std::vector<std::string> help;
  return help;
}

bool ccxResultPlotJobFrdCommand::execute(CubitCommandData &data)
{
