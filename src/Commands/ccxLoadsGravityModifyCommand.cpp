...
ccxLoadsGravityModifyCommand::ccxLoadsGravityModifyCommand()
{}

ccxLoadsGravityModifyCommand::~ccxLoadsGravityModifyCommand()
{}

std::vector<std::string> ccxLoadsGravityModifyCommand::get_syntax()
{
...
std::vector<std::string> ccxLoadsGravityModifyCommand::get_syntax_help()
{
...
std::vector<std::string> ccxLoadsGravityModifyCommand::get_help()
{
  std::vector<std::string> help;
  return help;
}

bool ccxLoadsGravityModifyCommand::execute(CubitCommandData &data)
{
