...
if (NOT CMAKE_VERSION VERSION_LESS "3.14.0")
  ...
  set (H5_FORTRAN_HAVE_SIZEOF FALSE)
  CHECK_FORTRAN_FEATURE(sizeof_code ${SIZEOF_CODE} H5_FORTRAN_HAVE_SIZEOF)

  # Check for F2008 standard intrinsic function C_SIZEOF
  set (H5_FORTRAN_HAVE_C_SIZEOF FALSE)
  CHECK_FORTRAN_FEATURE(c_sizeof_code ${C_SIZEOF_CODE} H5_FORTRAN_HAVE_C_SIZEOF)

  # Check for F2008 standard intrinsic function STORAGE_SIZE
  CHECK_FORTRAN_FEATURE(storage_size_code ${STORAGE_SIZE_CODE} H5_FORTRAN_HAVE_STORAGE_SIZE)

  # Check for F2008 standard intrinsic module "ISO_FORTRAN_ENV"
  set (H5_HAVE_ISO_FORTRAN_ENV FALSE)
  CHECK_FORTRAN_FEATURE(iso_fortran_env_code ${ISO_FORTRAN_ENV_CODE} H5_HAVE_ISO_FORTRAN_ENV)

  set (H5_FORTRAN_DEFAULT_REAL_NOT_DOUBLE FALSE)
  CHECK_FORTRAN_FEATURE(realisnotdouble_code ${REALISNOTDOUBLE_CODE} H5_FORTRAN_DEFAULT_REAL_NOT_DOUBLE)

  #-----------------------------------------------------------------------------
  # Checks if the ISO_C_BINDING module meets all the requirements
  #-----------------------------------------------------------------------------
  set (H5_FORTRAN_HAVE_ISO_C_BINDING FALSE)
  CHECK_FORTRAN_FEATURE(iso_c_binding_code ${ISO_C_BINDING_CODE} H5_FORTRAN_HAVE_ISO_C_BINDING)
endif ()
