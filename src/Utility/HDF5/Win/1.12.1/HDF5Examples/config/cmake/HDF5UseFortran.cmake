...
CHECK_TYPE_SIZE("__float128" H5_SIZEOF___FLOAT128)
if (${H5_SIZEOF___FLOAT128})
  SET (H5_HAVE_FLOAT128 1)
else ()
  SET (H5_HAVE_FLOAT128 0)
  SET (H5_SIZEOF___FLOAT128 0)
endif ()
...
if (${FORTRAN_HAVE_C_LONG_DOUBLE})
  set (H5_FORTRAN_HAVE_C_LONG_DOUBLE 1)
else ()
  set (H5_FORTRAN_HAVE_C_LONG_DOUBLE 0)
endif ()
...
if (${FORTRAN_C_LONG_DOUBLE_IS_UNIQUE})
  set (H5_FORTRAN_C_LONG_DOUBLE_IS_UNIQUE 1)
else ()
  set (H5_FORTRAN_C_LONG_DOUBLE_IS_UNIQUE 0)
endif ()
...
set (H5_H5CONFIG_F_NUM_IKIND "INTEGER, PARAMETER :: num_ikinds = ${NUM_IKIND}")
set (H5_H5CONFIG_F_IKIND "INTEGER, DIMENSION(1:num_ikinds) :: ikind = (/${pac_validIntKinds}/)")
...
set (H5_H5CONFIG_F_RKIND_SIZEOF "INTEGER, DIMENSION(1:num_rkinds) :: rkind_sizeof = (/${pack_real_sizeof}/)")
...
set (H5_FORTRAN_SIZEOF_LONG_DOUBLE ${H5_SIZEOF_LONG_DOUBLE})

# remove the invalid kind from the list
if (NOT(${H5_SIZEOF___FLOAT128} EQUAL 0))
   if (NOT(${H5_SIZEOF___FLOAT128} EQUAL ${max_real_fortran_sizeof})
       AND NOT(${H5_FORTRAN_SIZEOF_LONG_DOUBLE} EQUAL ${max_real_fortran_sizeof})
...
set (H5_H5CONFIG_F_NUM_RKIND "INTEGER, PARAMETER :: num_rkinds = ${NUM_RKIND}")

string (REGEX REPLACE "{" "" OUT_VAR ${PAC_FC_ALL_REAL_KINDS})
string (REGEX REPLACE "}" "" OUT_VAR ${OUT_VAR})
set (H5_H5CONFIG_F_RKIND "INTEGER, DIMENSION(1:num_rkinds) :: rkind = (/${OUT_VAR}/)")

string (REGEX REPLACE "{" "" OUT_VAR ${PAC_FC_ALL_REAL_KINDS_SIZEOF})
string (REGEX REPLACE "}" "" OUT_VAR ${OUT_VAR})
set (H5_H5CONFIG_F_RKIND_SIZEOF "INTEGER, DIMENSION(1:num_rkinds) :: rkind_sizeof = (/${OUT_VAR}/)")
...
if (H5_SIZEOF___FLOAT128 EQUAL 0 OR FLT128_DIG EQUAL 0)
  set (H5_HAVE_FLOAT128 0)
  set (H5_SIZEOF___FLOAT128 0)
...
if (${pos} EQUAL -1)
  set (H5_HAVE_Fortran_INTEGER_SIZEOF_16 0)
else ()
  set (H5_HAVE_Fortran_INTEGER_SIZEOF_16 1)
endif ()
