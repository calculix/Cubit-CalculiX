...
set (${LIBAEC_PACKAGE_NAME}_BUILD_SHARED_LIBS    ON)
set (${LIBAEC_PACKAGE_NAME}_EXPORT_LIBRARIES     aec-static;szaec-static)
...
set (${LIBAEC_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}/cmake")
...
set (${LIBAEC_PACKAGE_NAME}_VERSION_MINOR  6)
