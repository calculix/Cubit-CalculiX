...
set (${HDF5_PACKAGE_NAME}_BUILD_FORTRAN   True)
set (${HDF5_PACKAGE_NAME}_BUILD_CPP_LIB   True)
set (${HDF5_PACKAGE_NAME}_BUILD_JAVA      True)
set (${HDF5_PACKAGE_NAME}_BUILD_TOOLS     ON)
set (${HDF5_PACKAGE_NAME}_BUILD_HL_LIB    ON)
set (${HDF5_PACKAGE_NAME}_ENABLE_THREADSAFE OFF)
set (${HDF5_PACKAGE_NAME}_ENABLE_PLUGIN_SUPPORT True)
...
set (${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS      True)
...
if (NOT TARGET "hdf5")
  if (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS)
    include (${PACKAGE_PREFIX_DIR}/share/cmake/zlib/zlib-targets.cmake)
  endif ()
