...
set_target_properties(hdf5::hdf5-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5.so.310.5.1"
...
set_target_properties(hdf5::hdf5_tools-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_tools.so.310.0.6"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_tools.so.310"
  )

list(APPEND _cmake_import_check_targets hdf5::hdf5_tools-shared )
list(APPEND _cmake_import_check_files_for_hdf5::hdf5_tools-shared "${_IMPORT_PREFIX}/lib/libhdf5_tools.so.310.0.6" )
...
set_target_properties(hdf5::hdf5_hl-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_hl.so.310.0.6"
...
set_target_properties(hdf5::hdf5_f90cstub-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_f90cstub.so.310.3.2"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_f90cstub.so.310"
  )

list(APPEND _cmake_import_check_targets hdf5::hdf5_f90cstub-shared )
list(APPEND _cmake_import_check_files_for_hdf5::hdf5_f90cstub-shared "${_IMPORT_PREFIX}/lib/libhdf5_f90cstub.so.310.3.2" )
...
set_target_properties(hdf5::hdf5_fortran-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_fortran.so.310.3.2"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_fortran.so.310"
  )

list(APPEND _cmake_import_check_targets hdf5::hdf5_fortran-shared )
list(APPEND _cmake_import_check_files_for_hdf5::hdf5_fortran-shared "${_IMPORT_PREFIX}/lib/libhdf5_fortran.so.310.3.2" )
...
set_target_properties(hdf5::hdf5_hl_f90cstub-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_hl_f90cstub.so.310.0.6"
...
list(APPEND _cmake_import_check_files_for_hdf5::hdf5_hl_f90cstub-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl_f90cstub.so.310.0.6" )
...
set_target_properties(hdf5::hdf5_hl_fortran-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_hl_fortran.so.310.0.6"
...
list(APPEND _cmake_import_check_files_for_hdf5::hdf5_hl_fortran-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl_fortran.so.310.0.6" )
...
set_target_properties(hdf5::hdf5_cpp-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_cpp.so.310.0.6"
...
set_target_properties(hdf5::hdf5_hl_cpp-shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_hl_cpp.so.310.0.6"
...
set_target_properties(hdf5::hdf5_java PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_java.so.310.0.6"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_java.so.310"
  )

list(APPEND _cmake_import_check_targets hdf5::hdf5_java )
list(APPEND _cmake_import_check_files_for_hdf5::hdf5_java "${_IMPORT_PREFIX}/lib/libhdf5_java.so.310.0.6" )
