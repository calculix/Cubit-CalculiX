...
void UserOptionsPanel::refresh_settings()
{
  ...
  label_5->setText(ccx_uo.mPathIconsName);
  label_6->setText(ccx_uo.mPathPythonInterfaceName);
  ...
  lineEdit_5->setText(ccx_uo.mPathIcons);
  lineEdit_6->setText(ccx_uo.mPathPythonInterface);
}
...
void UserOptionsPanel::save_settings()
{
  ...
  ccx_uo.mPathIcons = lineEdit_5->text();
  ccx_uo.mPathPythonInterface = lineEdit_6->text();
}
