...
public:
  ...
  bool add_load(int load_id, int op_mode, int amplitude_id, int time_delay_id, int block_id, int direction_id, int magnitude_id, int coordinate_id); // adds new load to loads_data
  ...
  int  get_direction_data_id_from_direction_id(int direciton_id); // searches for the time_delay_id in the time_delay_data and returns the indices or -1 if it fails
  int  get_coordinate_data_id_from_coordinate_id(int direciton_id); // searches for the time_delay_id in the time_delay_data and returns the indices or -1 if it fails
