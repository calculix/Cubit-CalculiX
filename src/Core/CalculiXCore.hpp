...
public:
  ...
  std::vector<std::vector<std::vector<int>>> loadstrajectory_heatflux_get_face_ids(int trajectory_id); //returns face ids for the node ids from get_node_ids
  std::vector<std::vector<std::vector<int>>> loadstrajectory_heatflux_get_draw_face_ids(int trajectory_id); //returns face ids for the node ids from get_node_ids
  ...
  bool step_utility_modelchangeelement_step(int step_id); // modify step for modelchange
  ...
  bool result_plot_job_dat_section(int job_id, std::string x_section_set, std::string x_section_component, bool x_time, std::string y_section_set, std::string y_section_component, bool y_time, QString title, QString x_axis, QString y_axis, bool save, QString save_filepath); // plots the results
  ...
  bool result_csv_job_dat_section(int job_id,std::string result_set, std::string time,bool overwrite, std::string save_filepath); // save the results to csv
  ...
  std::vector<std::vector<int>> get_draw_data_for_load_bodyheatflux(int id); // returns block ids draw_data[][0] element ids draw_data[][1]
  ...
  bool draw_equationgroup(std::vector<int> equationgroup_ids,double size); // draw equationgroup
  ...
  bool draw_equationgroups(double size); // draw all equations
