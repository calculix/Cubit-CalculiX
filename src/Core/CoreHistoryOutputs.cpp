...
std::string CoreHistoryOutputs::print_data()
{
  ...
  str_return.append("node_id, nodeset_id, FREQUENCY, FREQUENCYF, TOTALS, GLOBAL, TIME POINTS, U, NT, TSF, TTF, PN, PSF, PTF, MACH, CP, VF, DEPF, TURB, MF, RF, RFL \n");
  ...
  str_return.append("element_id, elementset_id, FREQUENCY, FREQUENCYF, TOTALS, GLOBAL, TIME POINTS, S, SVF, E, ME, PEEQ, CEEQ, ENER, SDV, HFL, HFLF, COORD, ELSE, ELKE, EVOL, EMAS, EBHE, CENT \n");
  ...
  str_return.append("contact_id, contactpair_id, FREQUENCY, TOTALS, GLOBAL, TIME POINTS, CDIS, CSTR, CELS, CNUM, CF, CFN, CFS \n");
