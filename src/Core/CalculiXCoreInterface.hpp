...
public:
  ...
  bool step_utility_modelchangeelement_step(int step_id); // modify existing step for modelchange keyword
  ...
  bool draw_load_bodyheatflux(std::vector<int> bodyheatflux_ids,double size); // draw load surface traction 
