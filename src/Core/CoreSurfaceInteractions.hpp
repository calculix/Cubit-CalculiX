...
public:
  ...
  std::vector<std::vector<std::string>> surfaceinteraction_name_data; // name
  ...
  bool add_surfaceinteraction(int surfaceinteraction_id,int surfaceinteraction_name_id, int surfacebehavior_type, int surfacebehavior_type_id, int gap_conductance_id, int gap_heat_generation_id, int friction_id); // adds new surfaceinteraction to surfaceinteractions_data
  ...
  int  get_surfaceinteraction_name_data_id_from_surfaceinteraction_name_id(int surfaceinteraction_name_id); // searches for the surfaceinteraction_name_id in the surfaceinteraction_name_data and returns the indices or -1 if it fails
  ...
  std::string get_surfaceinteraction_export(); // get CalculiX surfaceinteractions exports
