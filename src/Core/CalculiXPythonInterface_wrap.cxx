...
#define SWIGTYPE_p_CalculiXPythonInterface swig_types[0]
...
/*-----------------------------------------------
              @(target):= _CalculiXPythonInterface.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__CalculiXPythonInterface

#else
#  define SWIG_init    init_CalculiXPythonInterface

#endif
#define SWIG_name    "_CalculiXPythonInterface"
