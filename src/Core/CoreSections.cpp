...
bool CoreSections::add_block(int block_id, int element_type_cubit, int element_type_ccx)
{
...
bool CoreSections::delete_block(int block_id)
{
...
bool CoreSections::modify_block_id(int block_id, int new_block_id)
{
  int blocks_data_id = get_blocks_data_id_from_block_id(block_id);
  if (blocks_data_id == -1)
  {
...
bool CoreSections::modify_block_element_type_cubit(int block_id, int new_cubit_element_type)
{
  int blocks_data_id = get_blocks_data_id_from_block_id(block_id);
  if (blocks_data_id == -1)
  {
...
bool CoreSections::modify_block_element_type_ccx(int block_id, int new_ccx_element_type)
{
  int blocks_data_id = get_blocks_data_id_from_block_id(block_id);
  if (blocks_data_id == -1)
  {
...
std::vector<std::string> CoreSections::get_ccx_element_types()
{ 
...
int CoreSections::get_blocks_data_id_from_block_id(int block_id)
{ 
  int return_int = -1;
  for (size_t i = 0; i < blocks_data.size(); i++)
  {
...
int CoreSections::get_ccx_element_type_id(std::string ccx_element_type)
{ 
  int return_int = -1;
...
int CoreSections::get_cubit_element_type_id(std::string cubit_element_type)
{ 
  int return_int = -1;
...
int CoreSections::get_standard_ccx_element_type_id(std::string cubit_element_type)
{ 
  int return_int = -1;
...
std::string CoreSections::get_ccx_element_type_name(int block_id)
{
  std::string str_return;
  str_return = "";
  int standard_id = -1;
