...
public:
  ...
  // bcs_data[0][4] keyword_type: 0 for boundary | 1 for temp
  ...
  bool add_bc(int bc_id, int op_mode, int amplitude_id, int time_delay_id, int keyword_type); // adds new bc to bcs_data
  ...
  int get_bc_keyword_type(int bc_id); // returns the keyword_type
