...
class CalculiXPythonInterface(object):
    ...
    def dat_get_buckle(self, job_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_dat_get_buckle(self, job_id)

    def dat_get_section_set(self, job_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_dat_get_section_set(self, job_id)

    def dat_get_section_data(self, job_id, section_set):
        return _calculix_pythoninterface.CalculiXPythonInterface_dat_get_section_data(self, job_id, section_set)

    def dat_get_section_label(self, job_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_dat_get_section_label(self, job_id)

    def loadstrajectory_get_load_type(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_get_load_type(self, trajectory_id)

    def loadstrajectory_heatflux_get_node_ids(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_heatflux_get_node_ids(self, trajectory_id)

    def loadstrajectory_heatflux_get_edge_ids(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_heatflux_get_edge_ids(self, trajectory_id)

    def loadstrajectory_heatflux_get_hit_coordinates(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_heatflux_get_hit_coordinates(self, trajectory_id)

    def loadstrajectory_heatflux_get_face_ids(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_heatflux_get_face_ids(self, trajectory_id)

    def loadstrajectory_heatflux_get_draw_face_ids(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_heatflux_get_draw_face_ids(self, trajectory_id)

    def loadstrajectory_heatflux_get_times(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_heatflux_get_times(self, trajectory_id)

    def loadstrajectory_heatflux_get_radius(self, trajectory_id):
        return _calculix_pythoninterface.CalculiXPythonInterface_loadstrajectory_heatflux_get_radius(self, trajectory_id)
