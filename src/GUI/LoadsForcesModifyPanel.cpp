...
LoadsForcesModifyPanel::LoadsForcesModifyPanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsForcesModifyPanel::~LoadsForcesModifyPanel()
{}

void LoadsForcesModifyPanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_0->text()!=""))
  {
    command.append("ccx modify force " +lineEdit_0->text());
