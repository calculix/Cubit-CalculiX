#ifndef JOBSMONITORDATSECTIONPLOT_HPP
#define JOBSMONITORDATSECTIONPLOT_HPP
...
class JobsMonitorDATSectionPlot : public QWidget
{
  Q_OBJECT
  
public:
  JobsMonitorDATSectionPlot();
  ~JobsMonitorDATSectionPlot();
...
#endif // JOBSMONITORDATSECTIONPLOT_HPP