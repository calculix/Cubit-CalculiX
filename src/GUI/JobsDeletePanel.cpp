...
JobsDeletePanel::JobsDeletePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
JobsDeletePanel::~JobsDeletePanel()
{}

void JobsDeletePanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_1->text()!=""))
  {
    command.append("ccx delete job " + lineEdit_1->text());
  }
