#ifndef LOADSTRAJECTORYHEATFLUXCREATEPANEL_HPP
#define LOADSTRAJECTORYHEATFLUXCREATEPANEL_HPP
...
class LoadsTrajectoryHeatfluxCreatePanel : public QWidget
{
  Q_OBJECT
  
public:
  explicit LoadsTrajectoryHeatfluxCreatePanel(QWidget *parent = 0);
  ~LoadsTrajectoryHeatfluxCreatePanel();
...
#endif // LOADSTRAJECTORYHEATFLUXCREATEPANEL_HPP