#ifndef STEPSLOADSTRAJECTORYTREE_HPP
#define STEPSLOADSTRAJECTORYTREE_HPP
...
class StepsLoadsTrajectoryTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  StepsLoadsTrajectoryTree(QTreeWidgetItem *parent);
  ~StepsLoadsTrajectoryTree();
...
#endif // STEPSLOADSTRAJECTORYTREE_HPP