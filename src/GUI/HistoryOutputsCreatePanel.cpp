...
HistoryOutputsCreatePanel::HistoryOutputsCreatePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
HistoryOutputsCreatePanel::~HistoryOutputsCreatePanel()
{}

void HistoryOutputsCreatePanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_1->text()!=""))
  {
    command.append("ccx create historyoutput name \"" +lineEdit_1->text() + "\"");
