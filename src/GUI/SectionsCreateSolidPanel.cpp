...
SectionsCreateSolid::SectionsCreateSolid(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
SectionsCreateSolid::~SectionsCreateSolid()
{}

void SectionsCreateSolid::on_pushButton_apply_clicked(bool)
{
