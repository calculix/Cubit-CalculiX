...
StepsLoadsTrajectoryTree::StepsLoadsTrajectoryTree(QTreeWidgetItem* parent):
  QTreeWidgetItem (parent),
  isInitialized(false)
{}

StepsLoadsTrajectoryTree::~StepsLoadsTrajectoryTree()
{
}

void StepsLoadsTrajectoryTree::initialize(int step_id_init)
{
  if(isInitialized)
    return;

  QTreeWidgetItem::setText(0,"Trajectory");
  CalculiXCoreInterface *ccx_iface = new CalculiXCoreInterface();
  this->setIcon(0,ccx_iface->getIcon2("StepsLoadsTrajectoryTree"));
  isInitialized = true;
  step_id = step_id_init;
}

void StepsLoadsTrajectoryTree::update()
{
  std::vector<std::vector<std::string>> loads_tree_data;
  loads_tree_data = ccx_iface->get_steps_loadstrajectory_tree_data(step_id); 
...
void StepsLoadsTrajectoryTree::clear()
{
...
void StepsLoadsTrajectoryTree::addLoad(QString load_id, QString load_name)
{
  ...
  LoadTreeChild->setIcon(0,ccx_iface->getIcon2("StepsLoadsTrajectoryTree"));  

  this->addChild(LoadTreeChild);
}

void StepsLoadsTrajectoryTree::removeLoad(QTreeWidgetItem *load)
{
  this->removeChild(load);
  delete load;
}

int StepsLoadsTrajectoryTree::get_child_id(std::string load_id)
{
  int int_return;
  int_return = -1;
