#ifndef STEPSMANAGEMENTITEM_HPP
#define STEPSMANAGEMENTITEM_HPP
...
class StepsManagementItem : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  StepsManagementItem(QTreeWidget *parent);
  ~StepsManagementItem();
