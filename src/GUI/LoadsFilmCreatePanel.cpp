...
LoadsFilmCreatePanel::LoadsFilmCreatePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsFilmCreatePanel::~LoadsFilmCreatePanel()
{}

void LoadsFilmCreatePanel::on_pushButton_apply_clicked(bool)
{
  ...
  {
    command.append("ccx create film sideset " + lineEdit_2->text() + " temperature " + lineEdit_3->text() + " coefficient " + lineEdit_4->text());
