...
#ifndef STEPSFIELDOUTPUTSTREE_HPP
#define STEPSFIELDOUTPUTSTREE_HPP
...
class StepsFieldOutputsTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  StepsFieldOutputsTree(QTreeWidgetItem *parent);
  ~StepsFieldOutputsTree();
...
#endif // STEPSFIELDOUTPUTSTREE_HPP