...
ConstraintsCreateTieFromCubitContactPairPanel::ConstraintsCreateTieFromCubitContactPairPanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
ConstraintsCreateTieFromCubitContactPairPanel::~ConstraintsCreateTieFromCubitContactPairPanel()
{}

void ConstraintsCreateTieFromCubitContactPairPanel::on_pushButton_apply_clicked(bool)
{
