...
#ifndef STEPSLOADSRADIATIONTREE_HPP
#define STEPSLOADSRADIATIONTREE_HPP
...
class StepsLoadsRadiationTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  StepsLoadsRadiationTree(QTreeWidgetItem *parent);
  ~StepsLoadsRadiationTree();
...
#endif // STEPSLOADSRADIATIONTREE_HPP