#ifndef LOADSRADIATIONMODIFYPANEL_HPP
#define LOADSRADIATIONMODIFYPANEL_HPP
...
class LoadsRadiationModifyPanel : public QWidget
{
  Q_OBJECT
  
public:
  explicit LoadsRadiationModifyPanel(QWidget *parent = 0);
  ~LoadsRadiationModifyPanel();
...
#endif // LOADSRADIATIONMODIFYPANEL_HPP