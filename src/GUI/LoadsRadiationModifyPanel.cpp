...
LoadsRadiationModifyPanel::LoadsRadiationModifyPanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsRadiationModifyPanel::~LoadsRadiationModifyPanel()
{}

void LoadsRadiationModifyPanel::on_pushButton_apply_clicked(bool)
{
  ...
  if (lineEdit_0->text()!="")
  {
    command.append("ccx modify radiation " + lineEdit_0->text());
    ...
    if (lineEdit_4->text()!="")
    {
      command.append(" emissivity \"" +lineEdit_4->text() + "\"");
    }
