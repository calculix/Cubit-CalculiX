...
#ifndef STEPSLOADSCENTRIFUGALTREE_HPP
#define STEPSLOADSCENTRIFUGALTREE_HPP
...
class StepsLoadsCentrifugalTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  StepsLoadsCentrifugalTree(QTreeWidgetItem *parent);
  ~StepsLoadsCentrifugalTree();
...
#endif // STEPSLOADSCENTRIFUGALTREE_HPP