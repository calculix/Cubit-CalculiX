...
StepsModifyModalDynamicPanel::StepsModifyModalDynamicPanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
  ...
  label_5->setText("DELTMX");
  label_6->setText("Steady State");
  label_7->setText("Initial \nTime Increment");
  label_8->setText("Time Period\nof Step");
  label_9->setText("Minimum \nTime Increment");
  label_10->setText("Maximum \nTime Increment");
  ...
  lineEdit_8->setPlaceholderText("Optional - relative Error for Steady State");
...
StepsModifyModalDynamicPanel::~StepsModifyModalDynamicPanel()
{}

void StepsModifyModalDynamicPanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_1->text()!=""))
  {
    command.append("ccx modify step " + lineEdit_1->text() + " modaldynamic");
    if (lineEdit_2->text()!="")
    {
    ...
    if (lineEdit_5->text()!="")
    {
      command.append(" deltmx " + lineEdit_5->text());
    }
    ...
    if (lineEdit_7->text()!="")
    {
      command.append(" initialtimeincrement " + lineEdit_7->text());
    }
    if (lineEdit_8->text()!="")
    {
      command.append(" timeperiodofstep " + lineEdit_8->text());
    }
    if (lineEdit_9->text()!="")
    {
      command.append(" minimumtimeincrement " + lineEdit_9->text());
    }
    if (lineEdit_10->text()!="")
    {
      command.append(" maximumtimeincrement " + lineEdit_10->text());
    }
  }
