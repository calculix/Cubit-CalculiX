...
AmplitudesCreatePanel::AmplitudesCreatePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
AmplitudesCreatePanel::~AmplitudesCreatePanel()
{}

void AmplitudesCreatePanel::on_pushButton_apply_clicked(bool)
{
