...
LoadsFilmModifyPanel::LoadsFilmModifyPanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
  ...
  label_0->setText("Film ID");
  label_1->setText("Name");
  label_2->setText("Sideset ID");
  label_3->setText("Temperature");
  label_4->setText("Coefficient");
  label_5->setText("Amplitude ID");
  label_6->setText("Time Delay");
  label_7->setText("Film Amplitude ID");
  label_8->setText("Film Time Delay");
  label_9->setText("OP");
...
LoadsFilmModifyPanel::~LoadsFilmModifyPanel()
{}

void LoadsFilmModifyPanel::on_pushButton_apply_clicked(bool)
{
  ...
  if (lineEdit_0->text()!="")
  {
    command.append("ccx modify film " + lineEdit_0->text());
    ...
    if (lineEdit_3->text()!="")
    {
      command.append(" temperature " +lineEdit_3->text());
    }

    if (lineEdit_4->text()!="")
    {
      command.append(" coefficient " +lineEdit_4->text());
    }
    ...
    if (lineEdit_7->text()!="")
    {
      command.append(" filmamplitude " +lineEdit_7->text());
    }
    if (lineEdit_8->text()!="")
    {
      command.append(" filmtimedelay " +lineEdit_8->text());
    }
