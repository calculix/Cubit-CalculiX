#ifndef CONTACTPAIRSMODIFYPANEL_HPP
#define CONTACTPAIRSMODIFYPANEL_HPP
...
public:
  explicit ContactPairsModifyPanel(QWidget *parent = 0);
...
#endif // CONTACTPAIRSMODIFYPANEL_HPP