...
#ifndef STEPSLOADSHEATFLUXESTREE_HPP
#define STEPSLOADSHEATFLUXESTREE_HPP
...
class StepsLoadsHeatfluxesTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  StepsLoadsHeatfluxesTree(QTreeWidgetItem *parent);
  ~StepsLoadsHeatfluxesTree();
...
#endif // STEPSLOADSHEATFLUXESTREE_HPP