...
void JobsMonitorFRD::addMaterial(QString material_id, QString material_name)
{
...
void JobsMonitorFRD::removeMaterial(MaterialManagementItem *material)
{
  tree_material->removeItemWidget(material,0);
  delete material;
}

void JobsMonitorFRD::printproperties()
{
  MaterialManagementItem *temp_child;
...
int JobsMonitorFRD::get_child_id(std::string material_id)
{
  int int_return;
  int_return = -1;
...
void JobsMonitorFRD::createListItems(MaterialManagementItem *material)
{
...
void JobsMonitorFRD::switchListItem(QListWidget* source, QListWidget* target)
{
...
void JobsMonitorFRD::loadWidget(QListWidgetItem* item)
{
  elastic_widget->hide();
  plastic_widget->hide();
  density_widget->hide();
...
void JobsMonitorFRD::setMaterial(QString material_id)
{
...
void JobsMonitorFRD::on_pushButton_ok_clicked(bool)
{
  //log = " clicked ok \n";
  //PRINT_INFO("%s", log.c_str());
...
void JobsMonitorFRD::on_pushButton_apply_clicked(bool)
{
...
void JobsMonitorFRD::on_pushButton_close_clicked(bool)
{
  //log = " clicked close \n";
  //PRINT_INFO("%s", log.c_str());
  this->close();
...
void JobsMonitorFRD::on_pushButton_new_clicked(bool)
{
  //log = " clicked new \n";
  //PRINT_INFO("%s", log.c_str());
...
void JobsMonitorFRD::on_pushButton_delete_clicked(bool)
{
  //log = " clicked delete \n";
  //PRINT_INFO("%s", log.c_str());
  //QStringList commands;
...
void JobsMonitorFRD::on_pushButton_add_clicked(bool)
{
  //log = " clicked add \n";
  //PRINT_INFO("%s", log.c_str());
...
void JobsMonitorFRD::on_pushButton_remove_clicked(bool)
{
  //log = " clicked remove \n";
  //PRINT_INFO("%s", log.c_str());
...
void JobsMonitorFRD::material_clicked(QTreeWidgetItem* item, int column)
{
...
void JobsMonitorFRD::material_changed(QTreeWidgetItem* current_item, QTreeWidgetItem* prev_item)
{
...
void JobsMonitorFRD::material_card_clicked(QListWidgetItem* item)
{
...
void JobsMonitorFRD::material_card_doubleclicked(QListWidgetItem* item)
{
  //log = " material card " + item->text().toStdString() + " clicked \n";
  //PRINT_INFO("%s", log.c_str()); 
...
void JobsMonitorFRD::material_card_changed(QListWidgetItem* current_item, QListWidgetItem* prev_item)
{
  if (current_item!=nullptr)
  {
