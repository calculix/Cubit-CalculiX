...
LoadsBodyHeatfluxCreatePanel::LoadsBodyHeatfluxCreatePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsBodyHeatfluxCreatePanel::~LoadsBodyHeatfluxCreatePanel()
{}

void LoadsBodyHeatfluxCreatePanel::on_pushButton_apply_clicked(bool)
{
  QStringList commands;
  QString command = "";

  if ((lineEdit_2->text()!="") && (lineEdit_4->text()!=""))
  {
    command.append("ccx create bodyheatflux " + lineEdit_2->text());
