...
#ifndef LOADSBODYHEATFLUXTREE_HPP
#define LOADSBODYHEATFLUXTREE_HPP
...
class LoadsBodyHeatfluxTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  LoadsBodyHeatfluxTree(QTreeWidgetItem *parent);
  ~LoadsBodyHeatfluxTree();
...
#endif // LOADSBODYHEATFLUXTREE_HPP