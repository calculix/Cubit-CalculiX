...
ContactPairsDeletePanel::ContactPairsDeletePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
  ...
  label_1->setText("Contact Pair ID");
...
ContactPairsDeletePanel::~ContactPairsDeletePanel()
{}

void ContactPairsDeletePanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_1->text()!=""))
  {
    command.append("ccx delete contactpair " + lineEdit_1->text());
  }
