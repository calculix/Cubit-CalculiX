...
LoadsTrajectoryDeletePanel::LoadsTrajectoryDeletePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsTrajectoryDeletePanel::~LoadsTrajectoryDeletePanel()
{}

void LoadsTrajectoryDeletePanel::on_pushButton_apply_clicked(bool)
{
