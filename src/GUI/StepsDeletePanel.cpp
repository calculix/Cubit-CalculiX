...
StepsDeletePanel::StepsDeletePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
StepsDeletePanel::~StepsDeletePanel()
{}

void StepsDeletePanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_1->text()!=""))
  {
    command.append("ccx delete step " + lineEdit_1->text());
  }
