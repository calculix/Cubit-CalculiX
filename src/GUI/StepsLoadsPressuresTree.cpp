...
StepsLoadsPressuresTree::StepsLoadsPressuresTree(QTreeWidgetItem* parent):
  QTreeWidgetItem (parent),
  isInitialized(false)
{}

StepsLoadsPressuresTree::~StepsLoadsPressuresTree()
{
}

void StepsLoadsPressuresTree::initialize(int step_id_init)
{
  if(isInitialized)
    return;
  ...
  this->setIcon(0,ccx_iface->getIcon2("StepsLoadsPressuresTree"));  
  isInitialized = true;
  step_id = step_id_init;
}

void StepsLoadsPressuresTree::update()
{
  std::vector<std::vector<std::string>> loads_tree_data;
  loads_tree_data = ccx_iface->get_steps_loadspressures_tree_data(step_id); 
...
void StepsLoadsPressuresTree::clear()
{
...
void StepsLoadsPressuresTree::addLoad(QString load_id, QString load_name)
{
  ...
  LoadTreeChild->setIcon(0,ccx_iface->getIcon2("StepsLoadsPressuresTree"));  

  this->addChild(LoadTreeChild);
}

void StepsLoadsPressuresTree::removeLoad(QTreeWidgetItem *load)
{
  this->removeChild(load);
  delete load;
}

int StepsLoadsPressuresTree::get_child_id(std::string load_id)
{
  int int_return;
  int_return = -1;
