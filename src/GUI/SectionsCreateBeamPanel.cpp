...
//ccx create section beam beam_type [rect|circ|block|pipe] block <block id> material <material id> thickness1 <thickness1> thickness2 <thickness2> x <x> y <y> z <z> [orientation <orientation_name>] [offset1 <offset1>] [offset2 <offset2>]


  if ((lineEdit_1->text()!="") && (lineEdit_2->text()!=""))
  {
    command.append("ccx create section beam beam_type ");
    command.append("block " + lineEdit_1->text() + " material " + lineEdit_2->text());
    if (lineEdit_3->text()!="")
    {
