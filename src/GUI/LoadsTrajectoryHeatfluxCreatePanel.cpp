...
LoadsTrajectoryHeatfluxCreatePanel::LoadsTrajectoryHeatfluxCreatePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsTrajectoryHeatfluxCreatePanel::~LoadsTrajectoryHeatfluxCreatePanel()
{}

void LoadsTrajectoryHeatfluxCreatePanel::on_pushButton_apply_clicked(bool)
{
