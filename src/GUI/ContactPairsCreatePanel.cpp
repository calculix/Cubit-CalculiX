...
ContactPairsCreatePanel::ContactPairsCreatePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
ContactPairsCreatePanel::~ContactPairsCreatePanel()
{}

void ContactPairsCreatePanel::on_pushButton_apply_clicked(bool)
{
...
void ContactPairsCreatePanel::on_radioButton_5_toggled(bool toggled)
{
  lineEdit_5->setDisabled(false);
  lineEdit_6->setDisabled(true);
}

void ContactPairsCreatePanel::on_radioButton_6_toggled(bool toggled)
{
