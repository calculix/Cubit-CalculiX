#ifndef LOADSFILMMODIFYPANEL_HPP
#define LOADSFILMMODIFYPANEL_HPP
...
class LoadsFilmModifyPanel : public QWidget
{
  Q_OBJECT
  
public:
  explicit LoadsFilmModifyPanel(QWidget *parent = 0);
  ~LoadsFilmModifyPanel();
...
#endif // LOADSFILMMODIFYPANEL_HPP