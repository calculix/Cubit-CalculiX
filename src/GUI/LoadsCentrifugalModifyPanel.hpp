#ifndef LOADSCENTRIFUGALMODIFYPANEL_HPP
#define LOADSCENTRIFUGALMODIFYPANEL_HPP
...
class LoadsCentrifugalModifyPanel : public QWidget
{
  Q_OBJECT
  
public:
  explicit LoadsCentrifugalModifyPanel(QWidget *parent = 0);
  ~LoadsCentrifugalModifyPanel();
