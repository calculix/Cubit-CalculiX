...
LoadsHeatfluxesModifyPanel::LoadsHeatfluxesModifyPanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsHeatfluxesModifyPanel::~LoadsHeatfluxesModifyPanel()
{}

void LoadsHeatfluxesModifyPanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_0->text()!=""))
  {
    command.append("ccx modify heatflux " +lineEdit_0->text());
