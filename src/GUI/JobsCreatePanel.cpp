...
JobsCreatePanel::JobsCreatePanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
JobsCreatePanel::~JobsCreatePanel()
{}

void JobsCreatePanel::on_pushButton_apply_clicked(bool)
{
  ...
  if ((lineEdit_1->text()!=""))
  {
    command.append("ccx create job name \"" +lineEdit_1->text() + "\"");
