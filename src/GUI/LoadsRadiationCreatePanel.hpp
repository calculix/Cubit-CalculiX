#ifndef LOADSRADIATIONCREATEPANEL_HPP
#define LOADSRADIATIONCREATEPANEL_HPP
...
class LoadsRadiationCreatePanel : public QWidget
{
  Q_OBJECT
  
public:
  explicit LoadsRadiationCreatePanel(QWidget *parent = 0);
  ~LoadsRadiationCreatePanel();
...
#endif // LOADSRADIATIONCREATEPANEL_HPP