...
#ifndef LOADSHEATFLUXESTREE_HPP
#define LOADSHEATFLUXESTREE_HPP
...
class LoadsHeatfluxesTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  LoadsHeatfluxesTree(QTreeWidgetItem *parent);
  ~LoadsHeatfluxesTree();
