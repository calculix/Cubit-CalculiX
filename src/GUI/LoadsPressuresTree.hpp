...
#ifndef LOADSPRESSURESTREE_HPP
#define LOADSPRESSURESTREE_HPP
...
class LoadsPressuresTree : public QObject, public QTreeWidgetItem
{
  Q_OBJECT

public:
  LoadsPressuresTree(QTreeWidgetItem *parent);
  ~LoadsPressuresTree();
