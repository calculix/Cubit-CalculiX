#ifndef LOADSGRAVITYMODIFYPANEL_HPP
#define LOADSGRAVITYMODIFYPANEL_HPP
...
class LoadsGravityModifyPanel : public QWidget
{
  Q_OBJECT
  
public:
  explicit LoadsGravityModifyPanel(QWidget *parent = 0);
  ~LoadsGravityModifyPanel();
