...
LoadsSurfaceTractionModifyPanel::LoadsSurfaceTractionModifyPanel(QWidget *parent) :
  QWidget(parent),
  isInitialized(false)
{
  if(isInitialized)
...
LoadsSurfaceTractionModifyPanel::~LoadsSurfaceTractionModifyPanel()
{}

void LoadsSurfaceTractionModifyPanel::on_pushButton_apply_clicked(bool)
{
