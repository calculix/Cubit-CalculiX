#ifndef STEPSMODIFYSTATICPANEL_HPP
#define STEPSMODIFYSTATICPANEL_HPP
...
class StepsModifyStaticPanel : public QWidget
{
  Q_OBJECT
  
public:
  explicit StepsModifyStaticPanel(QWidget *parent = 0);
  ~StepsModifyStaticPanel();
...
#endif // STEPSMODIFYSTATICPANEL_HPP